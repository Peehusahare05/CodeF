...
const HeroSection = ({ total, impact, topContributor, trendLabel, ecoScore }) => {
    ...
    return (
        <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-white via-slate-50/50 to-slate-100/30 shadow-[0_24px_50px_-34px_rgba(15,23,42,0.75)]">
            ...
            <div className="relative p-3 sm:p-4 lg:p-6 xl:p-8">
                <div className="mb-6">
                    ...
                    <h1 className="mt-3 text-2xl font-black text-slate-900 sm:text-3xl lg:text-4xl xl:text-5xl">
                ...
                <div className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4">
                    {/* Total CO2 */}
                    <div className="rounded-2xl border border-slate-200 bg-white/70 p-4 shadow-sm transition-shadow hover:shadow-md">
                    ...
                    {/* Eco Score */}
                    <div className="rounded-2xl border border-blue-200 bg-blue-50/50 p-4 shadow-sm transition-shadow hover:shadow-md">
                    ...
                    {/* Impact Level */}
                    <div className={`rounded-2xl border ${tone.border} ${tone.badgeBg} p-4 shadow-sm transition-shadow hover:shadow-md`}>
                    ...
                    {/* Trend */}
                    <div className="rounded-2xl border border-emerald-200 bg-emerald-50/50 p-4 shadow-sm transition-shadow hover:shadow-md">
                ...
                {/* Biggest Contributor */}
                {topContributor && (
                    <div className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-gradient-to-r from-slate-50 to-white p-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
